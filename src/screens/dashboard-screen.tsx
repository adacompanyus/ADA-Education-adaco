  ...
  if (activeTab === 'dashboard') {
    return <div className="min-h-screen bg-background relative pb-20">
        ...
        <div className="relative z-10 p-6 space-y-6">
          ...
          {/* Active Game Modal */}
          {activeGame && <div className="fixed top-0 left-0 right-0 bottom-0 w-screen h-screen bg-background/80 backdrop-blur-sm z-[9999] p-4 overflow-y-auto px-[16px] mx-0 my-0">
